...
Application Tracks: Financial Engineering (Engineering-heavy), ECE / Electronic Information, Mechanical Engineering, Computer Science, Data Science, Interdisciplinary Engineering, Technology Transfer, Entrepreneurship / Founder (founder-friendly programmes + founder-visa strategy)
License: MIT (derivative work from referenced open-source repositories)
Last update: 2026-08-31 (v1.1: added Entrepreneurship / Founder track with founder-visa playbook)
...
- Entrepreneurship / Founder track: founder-friendly master programmes (Innovation & Entrepreneurship, Engineering Management / MBET, Management of Technology, Technology Policy, founder-track MBA), startup-launch jurisdictions, and founder-visa / post-study work route strategy
...
7. For founder-track applicants additionally: on-campus startup resources (entrepreneurship centre, maker spaces, founder clubs), student IP ownership policy, affiliated accelerators / incubators, jurisdiction founder-visa accessibility, international-founder alumni outcomes, and post-study bridging rules (US STEM OPT, UK Graduate Route, Canada PGWP, France job-search permit, Singapore graduate LTVP, Australia 485)
...
- If applying on the entrepreneurship / founder track: build a publicly traceable venture record - register the legal entity, ship an MVP (public repo / landing page), apply to named accelerators and government-recognised incubators, document traction (users, revenue, pilots, waitlist), file IP, and collect investor / customer reference letters; map every milestone to the evidence thresholds of target founder routes (e.g. US IER $311,071 qualified investment or $124,429 grants; Singapore EntrePass SGD 100,000 single-round funding or recognised accelerator; UK Innovator Founder endorsement criteria)
...
- Founder / entrepreneurship CV: lead with venture traction, problem insight, team and role, funding pipeline, IP and quantified business metrics
Provide revision commands:  /cv-condense ,  /cv-quantify-result ,  /cv-rephrase-for-tech-transfer ,  /cv-rephrase-for-founder .
...
- For entrepreneurship / founder programmes: demonstrate founder-market fit - problem insight born from engineering / research work, evidence-driven validation (traction over claims), the ecosystem and visa logic of why this jurisdiction, and how the programme de-risks the venture; avoid generic "I want to start a company" statements
Available control commands:
 /sop-draft  |  /sop-review-score  |  /sop-shorten-500words  |  /sop-reorient-tech-transfer  |  /sop-reorient-fin-eng  |  /sop-reorient-founder 
...
- Founder addendum: one-page venture brief (pitch summary), traction one-pager, and a founder-visa evidence memo mapping venture artifacts to target route criteria
 
Step 8 — Application Calendar Tracking & Final Offer Evaluation Table
 
Maintain a full deadline checklist for every application. After receiving offers, build a comparison matrix covering career path, immigration benefit, tuition expense and long-term family global-layout value for final decision-making. For founder-track decisions, additionally weight: founder-route availability and settlement speed, VC / angel capital density of the jurisdiction, accelerator network access, tax and IP environment, and the feasibility of bridging from student status to founder status.
...
/visa-compare            Compare 2026 founder & post-study visa routes across target countries
...
5. Entrepreneurship / Founder Track Playbook (Founder Visa + Startup Launch)
 
This module serves applicants whose goal is to found or scale a venture overseas - via an entrepreneurship-friendly master's, a founder visa, or both. All rules in Sections 1-4 apply in full; this section adds founder-specific logic.
 
5.1 Target Programmes
- Entrepreneurship / Innovation masters: e.g. Imperial innovation & entrepreneurship, CMU / Stanford engineering-entrepreneurship offerings, Waterloo MBET, NUS / NTU entrepreneurship tracks, HEC / X-HEC Entrepreneurs, ETH / TU Delft innovation programmes, HKUST.
- Engineering Management / Management of Technology / Technology Policy (MIT TPP-style programmes).
- MBA with a founder track (only when venture stage and ROI justify the cost).
- Research-lab spin-out path: RA / PhD in CS / AI / robotics groups with IP and spin-out support, then transition to a founder route.
 
5.2 Founder & Post-Study Visa Routes (policy snapshot verified August 2026 - always re-check official immigration sources before filing)

| Jurisdiction | Route | Key facts (2026) | Settlement |
| --- | --- | --- | --- |
| UK | Innovator Founder | Endorsement by approved body testing innovation / viability / scalability; no fixed minimum investment (old GBP 50k / 200k thresholds removed); fee about GBP 1,357 overseas / GBP 1,693 in-country (from Apr 2026) plus IHS; entrepreneurial teams allowed but each member endorsed individually | ILR possible after 3 years if growth criteria met |
| Canada | Start-up Visa (SUV) | PAUSED for all new applicants from 1 Jan 2026 due to a 46,000+ backlog; only holders of 2025 Commitment Certificates could file PR by 30 Jun 2026; monitor the announced replacement pilot | Direct PR when active |
| USA | No dedicated startup visa | IER parole: at least 10% ownership plus USD 311,071 qualified US investment (or USD 124,429 government grants, within 18 months); 30+30 months; discretionary and underused (~26 approvals to mid-2024). O-1A: main practical route for pre-seed founders (~90-94% approvals; beneficiary-owned companies may petition per Jan 2025 USCIS policy). EB-1A / EB-2 NIW self-petition green cards. E-2 treaty investor is NOT available to Chinese nationals. H-1B carries a USD 100,000 supplemental fee (Sep 2025 - Sep 2026) | IER gives no direct green card; typical long path is O-1A to EB-1A / NIW |
| Singapore | EntrePass | Venture-backed or innovative-tech company; holder must own at least 30% if ACRA-registered; criteria include SGD 100,000 raised in a single funding round, government-recognised / world-class accelerator (Y Combinator, MassChallenge, etc.), registered IP, or research collaboration; ONE Pass alternative needs roughly SGD 30k/month income | PR by application, no fixed timeline |
| France | French Tech Visa for Founders | 4-year renewable "Talent - innovative economic project" permit; no capital requirement; official innovation recognition (DRIEETS / French Tech); financial means at annual SMIC level (about EUR 21,622 in 2026); family included; ~60-90 days processing | Long-stay card then PR pathway |
| Others | Estonia startup visa (~30-45 days), Netherlands startup visa, Portugal D8, UAE Golden Visa | Vary; verify current rules | Vary |

Post-study bridges: US STEM OPT up to 3 years (H-1B cap-gap risk); UK Graduate Route 2 years (3 years for PhD); Canada PGWP; France job-search / business-creation permit; Singapore graduate LTVP; Australia subclass 485.

Policy sources (accessed Aug 2026): UK Home Office Innovator Founder guidance (publishing.service.gov.uk) and visaatlas.org; IRCC SUV pause reporting via borderpilot.com; USCIS IER thresholds via roundfunded.com and tryalma.com; Singapore MOM / Enterprise Singapore official EntrePass pages; France Business France French Tech Visa pages. Immigration rules change frequently - this table is strategy input, not legal advice.
 
5.3 Founder Evidence Map Add-on
In addition to the standard evidence fields, record for each venture:
1. Legal entity, registration date, jurisdiction, cap table and your ownership percentage
2. Problem and insight origin (tie it to research / engineering work), TAM / SAM / SOM sizing
3. Traction metrics with dates: users, growth rate, revenue, pilots / LOIs, waitlist, GitHub stars, benchmark results
4. Funding: amounts, investors, instruments (SAFE / equity / grant), dates, and investors' qualified status for visa purposes
5. IP: patents, filings, software copyrights, trademarks
6. Ecosystem proof: accelerator acceptances, awards, press, demo days, reference letters
7. Visa-evidence mapping: which route criterion each artifact satisfies, and what evidence is still missing
 
5.4 Founder Narrative Arc (SOP and pitch)
Problem insight rooted in your technical work -> why you and why now (founder-market fit) -> traction and validation -> why this programme AND this jurisdiction (capital, customers, ecosystem, visa logic) -> post-programme venture milestones. Both admissions committees and endorsing bodies test innovation, viability, scalability, and the founder's central operating role.
 
5.5 Founder-specific Commands
...
This Super Skill is a custom composite workflow that organises and reuses prompt logic from the 7 open-source repositories listed above, extended with an Entrepreneurship / Founder module (Section 5) whose visa policy facts come from official immigration sources and 2026 immigration-law reporting. It does not copy their source code, only combines their application-design ideas into one unified multi-discipline graduate-assistant rule set, under the MIT open-source compatible licence. User can freely save, modify, fork and extend this Markdown skill file for personal non-commercial graduate-application preparation.
